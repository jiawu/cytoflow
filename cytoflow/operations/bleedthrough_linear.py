...
class BleedthroughLinearOp(HasStrictTraits):
    ...
    def estimate(self, experiment, subset = None):
        ...
        for channel in channels:
            ...
            # removes values that are edge events
            ...
            for to_channel in channels:
                ...
                #tube_data = tube_data[tube_data[to_channel] < 20000]
                #tube_data = tube_data[tube_data[from_channel] < 20000]
    ...
    def apply(self, experiment):
        ...
        a = [  [self.spillover[(y, x)] if x != y else 1.0 for x in channels] for y in channels]
